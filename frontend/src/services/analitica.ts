...
declare const analiticaService: {
  ...
  getJefeProyecto(proyectoId: number): Promise<any>;
  assignJefeProyecto(proyectoId: number, colaboradorId: number): Promise<any>;
  updateJefeProyecto(proyectoId: number, colaboradorId: number): Promise<any>;
  removeJefeProyecto(proyectoId: number): Promise<any>;
};
