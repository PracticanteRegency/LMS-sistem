...
# Servir archivos media SIEMPRE (no solo en DEBUG)
# Necesario porque Nginx proxea /api/media/ al backend
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
else:
    # En producción, servir media explícitamente ya que static() retorna [] con DEBUG=False
